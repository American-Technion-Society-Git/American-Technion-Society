        ...
        <div id="content">
          ...
          <div className="w-[70%] mx-auto my-12">
            <div className="flex justify-between">
              <div className="text-[#002147] w-[65%]">
          ...
          <div className="bg-[#F5F5F5] py-12">
            <div className="text-[41px] text-center">Giving that Spans Generations</div>
            <div className="w-[85%] mx-auto mt-12 flex flex-wrap gap-4 justify-between ">
              {approved.map((item, index) => (
                <div className="w-[380px]">
                  ...
                  <div className="mt-4 text-[19px] text-[#091f40]">{item.name}</div>
                  <div className="mt-2 text-[#091f40] h-[100px]"
                  >
                    {item.quote.split("</p>")[0].split("<p>")[1]}</div>
                  <button
                    onClick={() => {
                      setBlogModalData(item);
                    }}
                    className="mt-4 text-[#094d9a] underline underline-offset-4"
                    type="button"
                    data-bs-toggle="modal"
            ...
            <div className="container-fluid">
              <div className="content_block_inner">
                ...
                <div className="font-semibold">
                  ...
                  <p>
                  Technion graduates make incredible, life-
                  changing contributions to the world every
                  single day. We're proud that you are part of our
                  alumni community. Join us for fascinating
                  talks, hands-on workshops, online lectures,
                  networking opportunities in the U.S., and
                  campus visits and class reunions in Israel.
                  </p>
