...
import technion100 from './assets/technion100.png'
    ...
    const newImageData = [
        {
          name: "John Doe",
          images: [
            'https://i.imgur.com/xo9scLs_d.webp?maxwidth=520&shape=thumb&fidelity=high',
            'https://i.imgur.com/xo9scLs_d.webp?maxwidth=520&shape=thumb&fidelity=high',
            'https://i.imgur.com/xo9scLs_d.webp?maxwidth=520&shape=thumb&fidelity=high',
          ]
        },
                                ...
                                <>
                                    <div className="modal-body">
                                        ...
                                        <div className='contentForm'>
                                            ...
                                            <input className='form-control' value={designation} placeholder='Title' onChange={(e) => setDesignation(e.target.value)} required />
            ...
            <section className="hero">
                ...
                <div className="container-fluid">
                    ...
                    <div className="hero_inner">
                        <img src={technion100} alt="" className="img-fluid logo" />
                    </div>
                </div>
                <div className="el_1"></div>
                <div className="el_2"></div>
                <div className="el_3"></div>
                <div className="el_4">
                    <img src={globe} alt="" />
                </div>
            </section>
