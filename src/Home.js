...
const Home = ({ data, blog, roadmap, values }) => {
  ...
  return (
    <React.Fragment>
      ...
      <section className="hero shadow-sm">
      ...
      <section className="content_block h-[450px] flex items-center">
        <div className="container-fluid">
          <div className="content_block_inner">
            ...
            <div className="content_wrapper bg-transparent">
      ...
      <div className="w-[70%] mx-auto my-8">
        <div className="heading">
          <h1 style={{ color: "#000" }}>Reimagining the Next 100 Years</h1>
          <br />
          <p>
        ...
        <div className="flex justify-center flex-wrap gap-4 mt-4">
          {blogData.map((res, index) => {
            ...
            return (
              <div
                key={index}
                className="relative w-[440px] h-[300px] overflow-hidden group"
              >
                <img
                ...
                <div
                  className="
                                                 absolute top-0 left-0 w-full h-full bg-[#031523] hover:z-50  bg-opacity-80
                                                "
                >
      ...
      <div className="w-full bg-[#F3F7F6] py-8 mt-12 ">
        <div className="w-[70%] flex items-center justify-center mx-auto">
            ...
            <div className="relative size-[400px]">
              <div className="absolute z-50  rounded-full size-44 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 overflow-hidden">
                <img
                  src={naftali}
                  alt="Naftali"
                  className="absolute transform -translate-y-6"
                />
              </div>
              <img
                src={naftalibg}
          ...
          <div className="w-[50%]">
            <div className="text-[25.88px] text-[#094A94]">
            ...
            <button className="mt-4 px-4 py-3 bg-[#094D9A] text-white">
              Read More
            </button>
          </div>
        </div>
